...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editprojectmodal<?php echo $project['project_id']; ?>">
...
$selectedEmployee = $project['employee_id'];
