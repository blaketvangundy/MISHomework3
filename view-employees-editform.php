    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="">
          ...
          <div class="mb-3">
            <label for="ePosition<?php echo $employee['employee_id']; ?>" class="form-label">Position</label>
            <input type="text" class="form-control" id="ePosition<?php echo $employee['employee_id']; ?>" name="ePosition" value="<?php echo $employee['employee_position']; ?>">
          </div>
